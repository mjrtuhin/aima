...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum(name="connector_type"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("org_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("organizations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("channel", sa.Enum(name="campaign_channel"), nullable=False),
        sa.Column("status", sa.Enum(name="campaign_status"), server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("severity", sa.Enum(name="alert_severity"), server_default="medium"),
